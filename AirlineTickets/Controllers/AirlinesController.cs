...
namespace AirlineTickets.API.Controllers
{
    ...
    {
        private readonly IAirlinesService _partnerService;
        public AirlinesController(IAirlinesService ChucVuService)
        {
        ...
        [HttpPost]
        public IActionResult Create(AirlinesDto request)
        {
        ...
        public IActionResult Edit(AirlinesDto request)
        {
